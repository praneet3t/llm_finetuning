...
def main():
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        ...
        #unsloth/Qwen3-14B-Base-unsloth-bnb-4bit This is for Alpaca
        max_seq_length=4096,
        load_in_4bit=True,
    ...
    trainer = SFTTrainer(
        ...
        args=SFTConfig(
            ...
            per_device_train_batch_size=2,    # A100 80 GB handles batch of 8
    ...
    model.save_pretrained("qwen3_32b_oceanbench_lora")
    tokenizer.save_pretrained("qwen3_32b_oceanbench_lora")
